  ...
  <div>
    ...
    <!-- <transition name="fade"
        ...
        <el-form :model="loginForm" :rules="rules" ref="loginForm" label-position="left" label-width="0px"
          ...
          <el-form-item prop="password">
            <el-input type="password" v-model="loginForm.reppassword" @keyup.enter.native="handleSubmit"
                      auto-complete="off" placeholder="确认密码" suffix-icon="fa fa-lock"></el-input>
          </el-form-item>
